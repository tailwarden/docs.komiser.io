...
```
wget https://cli.komiser.io/3.0.14/komiser_Linux_x86_64 -O komiser
```

### Windows

```
wget https://cli.komiser.io/3.0.14/komiser_Windows_x86_64.zip
...
```
wget https://cli.komiser.io/3.0.14/komiser_Darwin_arm64 -O komiser
```

For AMD architecture (Intel Chip)

```
wget https://cli.komiser.io/3.0.14/komiser_Darwin_x86_64 -O komiser
```
